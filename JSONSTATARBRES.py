...
def apply():
    ...
    global frameCanvas, f, map_widget, frameLabelText, answer, new_df, frameLabelImage, frameImage, marqueurs, zone, data
    try:
        print(1)
        frameImage.destroy()
    ...
    if data[0] == 'TOUS' and data[1] == 'TOUS' and data[2] == "Quantité":
        ...
        f.patch.set_facecolor('#CCFFBB')                                        # Couleur de fond de "l'image" graphe
...
boutonApply = Button(frameBouton, text="APPLY", command=apply, bg=colorb)
boutonApply.pack(side=RIGHT, padx=40)

boutonQ1 = Button(frameBouton, text="Q1", command = demande1, bg=colorb)
boutonQ1.pack(side=LEFT, padx=10)

boutonQ2 = Button(frameBouton, text="Q2", command = demande2, bg=colorb)
boutonQ2.pack(side=LEFT, padx=10)

boutonQ3 = Button(frameBouton, text="Q3", command = demande3, bg=colorb)
