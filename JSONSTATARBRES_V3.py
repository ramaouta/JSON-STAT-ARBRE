...
path = r"D:\Masterclass\les_arbres\les-arbres.csv"
new_df = pandas.read_csv(r"D:\Masterclass\les_arbres\les-arbres.csv", sep = ';', header = 0)
arr_df = pandas.read_csv(r"D:\Masterclass\les_arbres\arrondissements.csv", sep = ';', header = 0)
arr_departement = pandas.read_csv(r"D:\Masterclass\les_arbres\departements-et-collectivites-doutre-mer-france.csv", sep = ';', header = 0)
...
def noData():
        global frameCanvas, answer, frameLabelText, frameLabelImage, frameMap, map_widget
        frameCanvas = Frame(frameGraph, bg=colorg, width=400, height=354)
        frameCanvas.pack(fill=BOTH, expand=True)
        ...
        map_widget = Frame(frameMap, bg=colorm, width=400, height=354)
...
frameDemande = Frame(frameGauche, bg=color, height = 380, width=600)
